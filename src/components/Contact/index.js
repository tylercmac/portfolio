    ...
    <div>
      <div className="effect varrius">
        ...
        <div className="buttons">
          ...
          <a href="https://www.instagram.com/wilderhikes/" className="insta" title="Find me on Instagram" target="_blank" rel="noreferrer"><i className="fa fa-instagram" aria-hidden="true" alt="Instagram"></i> </a>
